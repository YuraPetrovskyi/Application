    ...
    <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden divide-y divide-gray-100">
      {dates.map((dateStr) => {
        ...
        return (
          <div key={dateStr}>
            <div
              className={`px-5 py-2.5 flex items-center gap-3 ${isToday ? "bg-indigo-50" : "bg-gray-50"}`}
            >
              <span
              ...
              <div>
                <p
                  className={`text-[11px] font-semibold uppercase tracking-wide ${isToday ? "text-indigo-400" : "text-gray-400"}`}
                >
                  {date.format("ddd")}
                </p>
